...
const en: Translations = {
  ...
  countryHero: {
    eyebrowStudio: "STUDIO IA",
    titleLines: ["SAVE 15 HOURS A WEEK.", "WITHOUT HIRING."],
    subtitle: (countryWithPrep, capital, _isMorocco) =>
      `AIZEN automates repetitive tasks for SMEs ${countryWithPrep} — quotes, emails, client follow-ups — delivered in under 2 weeks. Based in ${capital}, available nationwide.`,
    ctaPrimary: "Free Audit →",
    ctaSecondary: "See Plans",
  },
  whyAizen: {
