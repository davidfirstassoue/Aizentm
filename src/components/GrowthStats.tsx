...
export function GrowthStats({ lang }: { lang: Lang }) {
  ...
  return (
    <section className="py-[40px] md:py-[80px] border-t border-[color:var(--border-soft)]">
      <div className="display-grid">
        <div style={{ gridColumn: "2 / -2" }} className="mb-8 md:mb-14">
          <Reveal>
        ...
        {/* PART 2: Sectors */}
        <div style={{ gridColumn: "1 / -1" }} className="mb-10 md:mb-20 overflow-hidden border-y border-[color:var(--border-faint)] py-10">
